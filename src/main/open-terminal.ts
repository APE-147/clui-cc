...
export function buildOpenTerminalAppleScript(terminalApp: CliTerminalApp, scriptPath: string): string {
  const escaped = escapeAppleScript(shellSingleQuote(scriptPath))
